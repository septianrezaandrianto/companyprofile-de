...
<body class="hold-transition login-page" style="background-color: #2C2B2A !important;">
<div class="login-box">
  <div class="login-logo">
    <a href="<?php echo base_url() ?>"><b style="color: white !important;">Dominic English</b></a>
  </div>
  <!-- /.login-logo -->
  <div class="card">
